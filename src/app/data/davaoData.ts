...
export const provinces: Province[] = [
  // Davao de Oro
  {
    ...
    hotels: [
      ...
      { name: "Comval Hotel", image: "comval-hotel.jpg" },
      ...
      { name: "Edgars Place", image: "edgars-place.jpg" },
    ],
  ...
  // Davao Occidental
  {
    ...
    hotels: [
      { name: "Lower Felis Travellers Inn", image: "lower-felis-travellers-inn.jpg" },
      ...
      { name: "Splash Blue Inland Resort", image: "splash-blue-inland-resort.jpg" },
      { name: "Elpise Inn", image: "elpise-inn.jpg" },
      { name: "Paradiso Davao Beachfront Hotel & Resort Don Marcelino", image: "paradiso-davao-beachfront-hotel-and-resort-don-marcelino.jpg" },
      ...
      { name: "Dona Adelina Mendoza Beach Resort", image: "dona-adelina-mendoza-beach-resort.jpg" },
      { name: "Jefritz Lodging", image: "jefritz-lodging.jpg" },
      { name: "Meybio Accommodation", image: "meybio-accommodation.jpg" },
  ...
  // Davao Oriental
  {
    ...
    spots: [
      ...
      { name: "Daya Farm and Adventure", category: "Rural", lat: 6.945, lng: 126.215, image: "daya-farm-and-adventure.jpg" },
    ],
    hotels: [
      ...
      { name: "Blue Bless Beach Resort", image: "blue-bless-beach-resort.jpg" },
      { name: "Surf Up Resort", image: "surf-up-resort.jpg" },
