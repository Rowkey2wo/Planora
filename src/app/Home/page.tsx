  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-sky-50 via-blue-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-16 py-32">
        ...
        {/* Province Cards Grid / Sidebar Layout */}
        <div className={`grid gap-6 mb-16 transition-all duration-500 ${selectedProvince ? 'lg:grid-cols-12' : 'md:grid-cols-2 lg:grid-cols-3'}`}>
          {/* Province Cards - Left Column when selected */}
          <div className={`${selectedProvince ? 'lg:col-span-4 space-y-4' : 'contents'}`}>
          ...
          {/* Selected Province Details - Right Column */}
          {selectedProvince && selected && (
            <div className="lg:col-span-8" style={{ animation: 'slideInFromRight 0.5s ease-out' }}>
                    ...
                    <div className="space-y-3">
                      {filteredSpots.map((spot, idx) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              onClick={() => setExpandedSpot(isExpanded ? null : spot.name)}
                            ...
                            >
                              <div className="px-4 pb-4">
                                <img 
                                  ...
                                  onError={(e) => {
                                    e.currentTarget.src = '/images/placeholder-spot.jpg';
                                  }}
                                />
                              </div>
                            </div>
